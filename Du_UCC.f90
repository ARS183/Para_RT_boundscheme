...
!===============´®ÐÐ===================
!
subroutine Du2Dx_PADE4_serial(u,d2f,pxflag)
    include 'openNS3d.h'		
!	real(kind=OCFD_REAL_KIND)::hx
    real(kind=OCFD_REAL_KIND)::u(1-LAP:nx+LAP),d2f(1-LAP:nx+LAP)
    real(kind=OCFD_REAL_KIND)::df(1-LAP:nx+LAP)
    ...
    elseif (pxflag==1) then
        ...
        call D2F_PADE4_circle(u,d2f,nx,hx)
...
subroutine Du2Dy_PADE4_serial(u,d2f,pyflag)
    include 'openNS3d.h'		
!	real(kind=OCFD_REAL_KIND)::hx
    real(kind=OCFD_REAL_KIND)::u(1-LAP:ny+LAP),d2f(1-LAP:ny+LAP)
    real(kind=OCFD_REAL_KIND)::df(1-LAP:ny+LAP)
    ...
    elseif (pyflag==1) then
        ...
        call D2F_PADE4_circle(u,d2f,ny,hy)
...
!============================Serial==========================
!
subroutine DuDx_UCC_UpWind_serial(u,d2f,df,pxflag)
    include 'openNS3d.h'		
!	real(kind=OCFD_REAL_KIND)::hx
    real(kind=OCFD_REAL_KIND)::u(1-LAP:nx+LAP),d2f(1-LAP:nx+LAP)
    real(kind=OCFD_REAL_KIND)::df(1-LAP:nx+LAP)
    ...
    elseif (pxflag==1) then
        ...
        call DF_UCC45_P_circle(u,d2f,df,nx,hx)
...
!-------------------------------------------------------
subroutine DuDy_UCC_UpWind_serial(u,d2f,df,pyflag)
    include 'openNS3d.h'		
!	real(kind=OCFD_REAL_KIND)::hx
    real(kind=OCFD_REAL_KIND)::u(1-LAP:ny+LAP),d2f(1-LAP:ny+LAP)
    real(kind=OCFD_REAL_KIND)::df(1-LAP:ny+LAP)
    ...
    elseif (pyflag==1) then
        ...
        call DF_UCC45_P_circle(u,d2f,df,ny,hy)
...
subroutine DuDx_UCC_DownWind_serial(u,d2f,df,pxflag)
    include 'openNS3d.h'		
!	real(kind=OCFD_REAL_KIND)::hx
    real(kind=OCFD_REAL_KIND)::u(1-LAP:nx+LAP),d2f(1-LAP:nx+LAP)
    real(kind=OCFD_REAL_KIND)::df(1-LAP:nx+LAP)
    ...
    elseif (pxflag==1) then
        ...
        call DF_UCC45_M_circle(u,d2f,df,nx,hx)
...
subroutine DuDy_UCC_DownWind_serial(u,d2f,df,pyflag)
    include 'openNS3d.h'		
!	real(kind=OCFD_REAL_KIND)::hx
    real(kind=OCFD_REAL_KIND)::u(1-LAP:ny+LAP),d2f(1-LAP:ny+LAP)
    real(kind=OCFD_REAL_KIND)::df(1-LAP:ny+LAP)
    ...
    elseif (pyflag==1) then
        ...
        call DF_UCC45_M_circle(u,d2f,df,ny,hy)
